...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE INDEX "comments_target_collection_idx" ON "comments" USING btree ("target_collection");
  ...
  CREATE INDEX "likes_target_collection_idx" ON "likes" USING btree ("target_collection");
  CREATE INDEX "likes_target_id_idx" ON "likes" USING btree ("target_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_comments_target_collection";
  DROP TYPE "public"."enum_likes_target_collection";`)
}
