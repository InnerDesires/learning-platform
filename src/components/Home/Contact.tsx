        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <motion.span
              ...
              className="inline-block px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-white/60 text-sm font-semibold tracking-wider uppercase mb-6"
            >
              {tag}
            </motion.span>
            <motion.h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {contactItems.map((item, i) => (
              <motion.a
                ...
                className="flex flex-col items-center gap-3 p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm hover:border-white/20 hover:bg-white/10 transition-colors duration-300"
              >
