...
type NetworkIcon = React.ComponentType<{ className?: string }>

/* Brand glyphs missing from lucide (paths from simple-icons), colored via currentColor. */
const WhatsAppIcon: NetworkIcon = ({ className }) => (
...
const ViberIcon: NetworkIcon = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
const networks = (
  url: string,
  title: string,
): { name: string; href: string; icon: NetworkIcon }[] => [
  {
    name: 'Telegram',
